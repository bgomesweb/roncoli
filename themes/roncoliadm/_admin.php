...
<div class="dash">
    <aside class="dash_sidebar">
        ...
        <ul class="dash_sidebar_nav">
            ...
            echo $nav("th-list", "slides/home", "Slides");
            echo $nav("briefcase", "empresa/home", "Empresa");
            echo $nav("leanpub", "historia/home", "História");
            echo $nav("calendar", "blog/home", "Eventos");
            echo $nav("cogs", "produtos/home", "Produtos");
            echo $nav("download", "catalogos/home", "Catálogos");
        ...
        <div class="dash_userbar">
            <div class="dash_userbar_box">
                <div class="dash_content_box">
                    <h1 class="icon-cog transition"><a href="<?= url("/admin/dash"); ?>">Roncoli <b>Admin</b></a></h1>
