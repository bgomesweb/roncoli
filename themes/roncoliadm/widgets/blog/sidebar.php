<div class="dash_content_sidebar">
    ...
    <p class="dash_content_sidebar_desc">Aqui você gerencia todos os eventos e categorias do site...</p>
    ...
    <nav>
        ...
        echo $nav("pencil-square-o", "blog/home", "Eventos");
        echo $nav("bookmark", "blog/categories", "Categorias");
        echo $nav("plus-circle", "blog/post", "Novo Evento");
        ?>
