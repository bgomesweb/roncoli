...
<section class="dash_content_app">
    <?php if (!$post): ?>
        <header class="dash_content_app_header">
            <h2 class="icon-plus-circle">Novo Evento</h2>
        </header>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/post"); ?>" method="post">
                ...
                <label class="label">
                    ...
                    <textarea name="subtitle" placeholder="O texto do seu evento" required></textarea>
                </label>
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            <h2 class="icon-pencil-square-o">Editar evento #<?= $post->id; ?></h2>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/blog/post/{$post->id}"); ?>" method="post">
                ...
                <label class="label">
                    <span class="legend">*Subtítulo:</span>
                    <textarea name="subtitle" placeholder="O texto do seu evento"
