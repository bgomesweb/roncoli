...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        <h2 class="icon-pencil-square-o">Slides</h2>
    </header>
    ...
    <div class="dash_content_app_box">
        <section>
            <div class="app_blog_home">
                <?php if (!$posts): ?>
                    <div class="message info icon-info">Ainda não existem slides cadastrados no site.</div>
                <?php else: ?>
                    <?php foreach ($posts as $post):
                        ...
                        <article>
                            ...
                            <h3 class="tittle">
                                <a target="_blank" href=" <?= url("/slides/{$post->uri}"); ?>">
                            ...
                            <div class="info">
                                ...
                                <p class="icon-pencil-square-o"><?= ($post->status == "post" ? "Slide" : ($post->status == "draft" ? "Rascunho" : "Lixo")); ?></p>
                            </div>

                            <div class="actions">
                                <a class="icon-pencil btn btn-blue" title=""
                                   href="<?= url("/admin/slides/post/{$post->id}"); ?>">Editar</a>

                                <a class="icon-trash-o btn btn-red" title="" href="#"
                                   data-post="<?= url("/admin/slides/post"); ?>"
                                   data-action="delete"
