...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        <h2 class="icon-pencil-square-o">Produto</h2>
        <form action="<?= url("/admin/produtos/home"); ?>" method="post" class="app_search_form">
    ...
    <div class="dash_content_app_box">
        <section>
            <div class="app_blog_home">
                <?php if (!$posts): ?>
                    <div class="message info icon-info">Ainda não existem produtos cadastrados no site.</div>
                <?php else: ?>
                    <?php foreach ($posts as $post):
                        ...
                        <article>
                            ...
                            <h3 class="tittle">
                                <a target="_blank" href=" <?= url("/produtos/{$post->uri}"); ?>">
                            ...
                            <div class="info">
                                ...
                                <p class="icon-pencil-square-o"><?= ($post->status == "post" ? "Produto" : ($post->status == "draft" ? "Rascunho" : "Lixo")); ?></p>
                            </div>
