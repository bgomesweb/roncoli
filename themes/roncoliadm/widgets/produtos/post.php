...
<section class="dash_content_app">
    <?php if (!$post): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/produtos/post"); ?>" method="post">
                <!-- ACTION SPOOFING-->
    ...
    <?php else: ?>
        <header class="dash_content_app_header">
            ...
            <a class="icon-link btn btn-green" href="<?= url("/produtos/{$post->uri}"); ?>" target="_blank" title="">Ver no
                site</a>
        </header>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/produtos/post/{$post->id}"); ?>" method="post">
                ...
                <label class="label">
                    <span class="legend">*Título:</span>
                    <input type="text" name="title" value="<?= $post->title; ?>" placeholder="Nome do Produto"
                           required/>
                </label>
