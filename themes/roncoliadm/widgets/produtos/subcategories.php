...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        <h2 class="icon-pencil-square-o">Sub Categorias</h2>
        <a class="icon-plus-circle btn btn-green" href="<?= url("/admin/produtos/subcategory"); ?>">Nova Sub Categoria</a>
    </header>
    ...
    <div class="dash_content_app_box">
        <section>
            <div class="app_blog_categories">
                <?php if (!$categories): ?>
                    <div class="message info icon-info">Ainda não existem sub categorias cadastradas em seu site</div>
                <?php else: ?>
