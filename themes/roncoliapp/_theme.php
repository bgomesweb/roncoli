...
<div class="app">
    <header class="app_header">
        <h1><a class="icon-coffee transition" href="<?= url("/app"); ?>" title="Roncoli">Roncoli</a></h1>
    ...
    <div class="app_box">
        <nav class="app_sidebar radius box-shadow">
            ...
            <div class="app_sidebar_user app_widget_title">
                <span class="user">
                    <?php if (user()->photo()): ?>
                        <img class="rounded" alt="<?= user()->company_name; ?>" title="<?= user()->company_name; ?>"
    ...
    <footer class="app_footer">
        <span class="icon-coffee">
            Roncoli - Desenvolvido por Bruno Gomes<br>
